...
class CNNModel(nn.Module):
    def __init__(self):
        ...
        # convolution 1
        self.c1 = nn.Conv2d(in_channels=1, out_channels=16, kernel_size=(5, 5), stride=[1], padding=1)
        self.relu1 = nn.ReLU()
        # maxpool 1
        ...
        # convolution 2
        self.c2 = nn.Conv2d(in_channels=16, out_channels=32, kernel_size=(3,3), stride=[1], padding=1)
        self.relu2 = nn.ReLU()
        # maxpool 2
        ...
        # convolution 3
        self.c3 = nn.Conv2d(in_channels=32, out_channels=64, kernel_size=(3, 3), stride=[1], padding=1)
        self.relu3 = nn.ReLU()
        # maxpool 3
        ...
        # convolution 4
        self.c4 = nn.Conv2d(in_channels=64, out_channels=128, kernel_size=(3, 3), stride=[1], padding=1)
        self.relu4 = nn.ReLU()
        # maxpool 4
        ...
        # convolution 5
        self.c5 = nn.Conv2d(in_channels=128, out_channels=252, kernel_size=(3, 3), stride=[1], padding=1)
        self.relu5 = nn.ReLU()
        # maxpool 5
